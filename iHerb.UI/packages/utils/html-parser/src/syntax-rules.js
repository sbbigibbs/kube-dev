export default `
    Root "root"
    = "<root>" _ children:TagList _ "</root>" {
        return {
            type: "root",
            children: children
        }
    ...
    Tag "tag"
    = _ "<" beginTag:TagName _ attributes:AttributeList? ">" text:Text "</" endTag:TagName ">" _ {
        return {
            type: "tag",
            tagName: beginTag,
    ...
    / _ "<" beginTag:TagName _ attributes:AttributeList? ">" children:TagList "</" endTag:TagName ">" _ {
        return {
            type: "tag",
            tagName: beginTag,
            attributes: attributes,
    ...
    DoubleQuotedAttribute
    = _ key:AttributeName "=" '"' value:AttributeValue '"' {
        return {
            key: key,
            value: value
        }
    ...
    AttributeValue
    = tokens:AttributeValueTokens* { return tokens.join("") }
