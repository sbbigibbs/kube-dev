...
var checkout = process.env.CHECKOUT_API_URL || "https://checkout-api.iherbtest4.biz/v1",
    myaccount = process.env.MYACCOUNT_API_URL || "https://myaccount-api.iherbtest4.biz/v1";
