...
function genPluginModuleResolver(opts) {
  opts || (opts = {})
  if (_.has(opts, 'moduleResolver.alias')) {
    var obj = {}
    obj[_.get(opts, 'moduleResolver.alias.name')] = _.get(opts, 'moduleResolver.alias.val')
...
module.exports = function (opts) {
  return {
    ...
    plugins: [
      ...
      new InterpolateHtmlPlugin(opts.raw),
